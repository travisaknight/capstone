...
Exercise.create!(name: "Push-ups", category_id: 1, video_url: "https://www.youtube.com/watch?v=sBfW0tj9fqg")
Exercise.create!(name: "Pull-ups", category_id: 1, video_url: "https://www.youtube.com/watch?v=3Eq4VF5SudM")
Exercise.create!(name: "Lunges", category_id: 2, video_url: "https://www.youtube.com/watch?v=-P9HIPp1QG4")
Exercise.create!(name: "Deadlift", category_id: 2, video_url: "https://www.youtube.com/watch?v=T7-p5RBADIY")
Exercise.create!(name: "Pallof Press", category_id: 3, video_url: "https://youtu.be/5_8d8vHgZvU?t=42")
